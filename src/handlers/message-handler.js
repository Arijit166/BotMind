// ❌ REMOVE: The direct import of the config object
// import config from '../../config.js';
import { createModuleLogger } from '../utils/logger.js';

export class MessageHandler {
  // 🟢 CORRECTED: Accept 'config' as a parameter and use consistent naming
...
    
    // 🟢 CORRECTED: Access properties from 'this.config'
...
      // 🟢 CORRECTED: Access config property from 'this.config'
...
      // 🟢 CORRECTED: Access config properties from 'this.config'
...
    // WhatsApp ID format: "1234567890@c.us" -> "1234567890"
